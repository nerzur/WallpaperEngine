...
package cu.havanaclub.wallpaperengine.util.unsplash;
...
import cu.havanaclub.wallpaperengine.util.unsplash.model.UnsplashPhotoStatistic;
...
public class UnsplashClient {
	 ...
	 * @return
	 */
	public cu.havanaclub.wallpaperengine.util.unsplash.model.UnsplashImage[] getPhotos(int page, int perPage, UnsplashSort sort) {
	...
	public UnsplashImage[] getRandomPhoto(UnsplashSearchQuery unsplashSearchQuery) {
		return getRandomPhoto(
				unsplashSearchQuery.getCollections() == null ? "" : unsplashSearchQuery.getCollections(),
				unsplashSearchQuery.getFeatured() == null ? "" : unsplashSearchQuery.getFeatured(),
				unsplashSearchQuery.getUsername() == null ? "" : unsplashSearchQuery.getUsername(),
				unsplashSearchQuery.getQuery() == null ? "" : unsplashSearchQuery.getQuery(),
				unsplashSearchQuery.getWidth(),
				unsplashSearchQuery.getHeight() ,
				unsplashSearchQuery.getOrientation(),
				unsplashSearchQuery.getCount()
		);
	}
